...
const  // Constantes locales del cuerpo del programa principal
    ...
    Entrega_jose : real = 7.0;  //se ha remplazado Entrega_jperez por Entrega_jose
    Teoria_jperez: real = 7.0;
    Prac_jperez: real = 6.5;

begin
    write('Nota final: ');
    if (hace_media( Compensable, Entrega_jose, Teoria_jperez, Prac_jperez))
    then writeln( media(Peso_entrega, Peso_teoria, Peso_prac, Entrega_jose,
